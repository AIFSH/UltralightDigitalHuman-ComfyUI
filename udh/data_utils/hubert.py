...
import torch
import os
print(os.environ['hubert_model_dir'])
print("Loading the Wav2Vec2 Processor...")
wav2vec2_processor = Wav2Vec2Processor.from_pretrained(os.environ['hubert_model_dir'])
print("Loading the HuBERT Model...")
hubert_model = HubertModel.from_pretrained(os.environ['hubert_model_dir'])
